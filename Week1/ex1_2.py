...
time_per_mile_seconds = (int(((minutes/miles) - time_per_mile_minutes) * 60))
...
print("4. What is your average pace? Answer:", time_per_mile_minutes, "minutes", time_per_mile_seconds, "seconds")
